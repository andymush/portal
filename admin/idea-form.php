            ...
            <div class="control-group">
              <form action="idea.php" method="POST" name="ideas">
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input name="myname" type="text" class="col-lg-6 leftradius" placeholder="Your Name" class="span11" required/>
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Idea :</label>
                  <div class="controls">
                  <textarea name="idea" rows="6" class="span12" placeholder="Enter idea ..." required></textarea>
                  </div>
                </div>
                <input value="Submit Idea" type="submit" name="submit" class="btn btn-primary btn-lg">
                <br/>
              </form>
          </div>
          </div>
