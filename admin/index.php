...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li><a href="forms.php"><i class="icon icon-th-list"></i> <span>Forms</span></a></li>
    ...
    <div class="container-fluid">
      <div class="quick-actions_homepage">
        <ul class="quick-actions">
              <li class="bg_lb span5"> <a href="index.php"> <i class="icon-dashboard"></i> My Dashboard </a> </li>
        </ul>
      </div>
    </div>
    <div class="container-fluid"> 
      <div class="quick-actions_homepage">
        <ul class="quick-actions">
              <li class="bg_lo span6"> <a href="forms.php"> <i class="icon-th-list"></i> Forms</a> </li>
        </ul>
      </div>
    </div>
    <div class="container-fluid">
      <div class="quick-actions_homepage">
        <ul class="quick-actions">
              <li class="bg_lb span7"> <a href="tables.php"> <i class="icon-th-list"></i> Tables</a> </li>
        </ul>
      </div>
    </div>
    <div class="container-fluid">
      <div class="quick-actions_homepage">
        <ul class="quick-actions">
              <li class="bg_lo span5"> <a href="comments.php"> <i class="icon-th-list"></i> Comments</a> </li>
        </ul>
      </div>
    </div>
<!--End-Action boxes-->    
