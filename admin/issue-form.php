      ...
      <div class="widget-box"><a href="forms.php" class="btn btn-success">Back</a>
        ...
        <div class="widget-content">
          ...
          <div class="control-group">
              ...
              <div class="controls">
              <input type="text" name="username" Placeholder="Name" class="span11" required/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Your location :</label>
              <div class="controls">
                <input name="location" type="text" id="name" placeholder="Your location" class="span11" required/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Issue :</label>
              <div class="controls">
               <textarea id="message" name="issue" class="span12" placeholder="Write your issue..." rows="6" required></textarea>
              </div>
            </div>
            <input value="Submit Issue" type="submit" name="submit"  class="btn btn-primary btn-lg">
            <br/>
          </form>
        </div>
      </div>
