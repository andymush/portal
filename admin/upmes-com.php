...
<html>
	<head>
        ...
        <h4 class="text-center">Update Message comment</h4>
	</head>
	<body>
    <div class="container">
        <div class="row">
...
$queryupdate=mysqli_query($conn,"update messcom set comment='$ucomment',idno='$uidno' where id='$id'")or die(mysqli_error($conn));
