                ...
                <div class="panel-body minimal">                                    
                  ...
                  <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="videa.php?id=<?php echo$row['id']?>" class='btn btn-success'>View</a>,<a href="com-idea.php?id=<?php echo$row['id']?>" class='btn btn-default'>Comment</a></td>
                        </tr>
                        <?php
                        }
                        ?>
                  ...
                  <a href="didea.php" class='btn btn-success'>Display Comments</a>                 
                </div>
              </section>
            </div>
          </div>
