            ...
            <div class="col-sm-9">
              <section class="panel">
                <header class="panel-heading wht-bg">
                  	<h4 class="gen-case"><i class="fa fa-angle-right "></i>Messages</h4>
                </header>
                <div class="panel-body minimal">                                
                  <div class="table-inbox-wrap ">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="vimessage.php?id=<?php echo$row['id']?>"class='btn btn-success'>View</a>,<a href="com-message.php?id=<?php echo$row['id']?>" class='btn btn-default'>Comment</a></td>
                      </tr>
                      <?php
                        }
                      ?>
                  ...
                  <a href="dimmessage.php" class='btn btn-success'>Display Comments</a> 
                </div>
              </section>
            </div>
          </div>
