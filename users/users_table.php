            ...
            <div class="col-md-12">
              <div class="content-panel">
                <table class="table table-striped table-advance table-hover">
                  <h4><i class="fa fa-angle-right"></i> Users Registered On HomeTrack.</h4>
                  <hr>
                  <thead>
                    <tr>
                      <th></i> Id #</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['region']?>, <?php echo $row['country']?></td>
                      <td><?php echo $row['email']?></td>
                        <?php echo "<td> 
                          <a href='users_view.php?id=".$row['id']."' class='btn btn-success btn-xs'><i class='fa fa-eye'></i></a>   
                          <a href='users_update.php?id=". $row['id'] ."' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></a>
                          <a href='users_delete.php?id=". $row['id'] ."' class='btn btn-danger btn-xs'><i class='fa fa-trash-o'></i></a></td>"
                        ;?>
                    </tr>
                    <?php
                      }
