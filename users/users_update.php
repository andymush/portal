...
if (isset($_SESSION['signedin']) && $_SESSION['signedin'] === TRUE) {
          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              ...
              <ul class="sub">
                ...
                <li class="active"><a href="users_table.php">HomeTrack Users</a></li>
        ...
        <section class="wrapper">
          ...
          <div class="row mt">
            ...
            <div class="form-panel">
              <h4><i class="fa fa-angle-right"></i> User Update</h4>
              <hr>
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="">
                  ...
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Email Address</label>
                    <div class="col-lg-10">
                  ...
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Country</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="country" name="country" type="text" value="<?php echo $country;?>" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Region</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="region" name="region" type="text" value="<?php echo $region;?>" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Estate</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="estate" name="estate" type="text" value="<?php echo $estate;?>" />
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <input type="submit" name="update" class="btn btn-theme" value="Save">
                      <a href="users_table.php" class="btn btn-theme04" type="button">Cancel</a>
                    </div>
                  </div>
                </form>
              </div>
  ...
  if(isset($_POST['update'])){
     ...
     $uestate=$_POST['estate'];
     $queryupdate=mysqli_query($conn,"update users set name='$uname', password='$upassword', email='$uemail', phone='$uphone', country='$ucountry', region='$uregion', estate='$uestate' where id='$id'")or die(mysqli_error($conn));
     if($queryupdate){
