              ...
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="phone" name="phone" type="text" value="<?php echo $phone;?>" readOnly />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Residence</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="country" name="country" type="text" value="<?php echo $estate;?>" readOnly />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Location</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="region" name="region" type="text" value="<?php echo $region;?>, <?php echo $country;?>" readOnly/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-offset-1 col-lg-10">
                      <center>
                        <a href="users_table.php" class="btn btn-primary" style="width: 30%;"><i class="fa fa-reply"></i></a>
                      </center>
                    </div>
                  </div>
                </form>
