        ...
        <section class="wrapper">
          ...
          <div class="row mt">
            ...
            <div class="form-panel">
              <h4><i class="fa fa-angle-right"></i> Message </h4>
              <hr>
              <div class="form">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" name="id" type="int" value="<?php echo $id;?>" readOnly/>
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Name</label>
                    <div class="col-lg-10">
                      <input class=" form-control" name="fname" type="text" value="<?php echo $fname;?>" readOnly/>
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Message</label>
                    <div class="col-lg-10">
                      <input class=" form-control" name="message" type="text" value="<?php echo $message;?>" readOnly/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-offset-1 col-lg-10">
                      <center>
                        <a href="com-message.php" class="btn btn-primary" style="width: 30%;">Comment</a><a href="messages.php" class="btn btn-success" style="width: 30%">Back</a>
                      </center>
