        ...
        <section class="wrapper">
          ...
          <div class="row mt">
            ...
            <div class="form-panel">
              <h4><i class="fa fa-angle-right"></i> Issue breakdown </h4>
              <hr>
              <div class="form">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" name="id" type="text" value="<?php echo $uid;?>" readOnly/>
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" name="location" type="text" value="<?php echo $location;?>" readOnly />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="firstname" class="control-label col-lg-2">Issue</label>
                    <div class="col-lg-10">
                      <input class=" form-control" name="issue" type="text" value="<?php echo $issue;?>" readOnly/>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-lg-offset-1 col-lg-10">
                      <center>
                        <a href="com-issue.php" class="btn btn-primary" style="width: 30%;">Comment</a><a href="index.php" class="btn btn-success" style="width: 30%">Back</a>
                      </center>                    
